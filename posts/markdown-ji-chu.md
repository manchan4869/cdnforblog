---
title: 'Markdown: 基础'
date: 2020-05-12 01:32:07
tags: [Markdown]
published: true
hideInList: false
feature: http://markdown.tw/images/208x128.png
isTop: false
---
...
一个段落是由一个以上的连接的行句组成，而一个以上的空行则会切分出不同的段落（空行的定义是显示上看上去像是空行，就被视为空行，例如有一行只有空白和 tab，那该行也会被视为空行），一般的段落不需要用空白或断行缩排。
